...
alter table public.modules
  add column parent_id uuid references public.modules(id) on delete cascade;

create index modules_parent_idx on public.modules(parent_id, position);
...
-- ---------------------------------------------------------------------------
alter table public.lessons add column thumbnail_path text;
